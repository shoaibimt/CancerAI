...
tab1,tab2,tab3,tab4,tab5,tab6, tab7 = st.tabs(['Classification', 'Virtual Screening', 'Help', 'About CancerAI', 'Datasets', 'Model details',  'Contact Us'])
...
with tab7:
  ...
  #st.markdown('<p> Lab No. 204 & 309, Anticancer drug development lab, ACBR, university of Delhi, North Campus, Delhi</p>', unsafe_allow_html=True)
############################## coding ends #################################